  ...
  <footer class="site-footer">
    <div class="container footer__grid">
      <div class="footer__brand">
        ...
        <p>Empowering Independence Through Safe Riding. Premium scooty & bike training for women and beginners across Kolkata since 2018.</p>
        <div class="socials">
    ...
    <div class="container footer__bottom">
      ...
      <span>Made with ❤ In Kolkata · <a href="${p('privacy.html')}">Privacy</a> · <a href="${p('terms.html')}">Terms</a></span>
    </div>
  </footer>
